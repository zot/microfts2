# CLI
**Requirements:** R1, R34, R39, R41, R48, R49, R50, R57, R58, R59, R60, R61, R62, R70, R71, R72, R73, R74, R89, R100, R108
...
- search: query and print `filepath:startline-endline` per result; --regex for regex pattern mode; --score coverage|density
...
- score: score named files against a query, print `filepath:startline-endline\tscore` per chunk
