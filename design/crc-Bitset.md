...
Fixed-size bitset for 16,777,216 trigrams (2^24). Stored as 2,097,152 bytes (2MB). Exported type for use by Ark and other consumers. Not used internally by microfts2 (C records use sparse index records; trigram selection is dynamic via TrigramFilter).
