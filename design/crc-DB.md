...
- AppendTmpFile(path, strategy, content, opts): delegate to overlay.appendFile, return (fileid, error). Shell >> semantics: create if absent, append if exists
