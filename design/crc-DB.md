...
- stock filters: FilterAll, FilterByRatio, FilterBestN. FilterByRatio only discriminates at `totalChunks >= 2`; below that it returns all trigrams unmodified (R674)
